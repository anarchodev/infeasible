...
emcc -O2 -I"$root/src" \
    ...
    -sEXPORTED_FUNCTIONS=_inf_compile,_inf_free,_inf_intern,_inf_name,_inf_query,_inf_get,_inf_set,_inf_get_num,_inf_set_num,_inf_interface,_inf_step,_inf_step1,_inf_emit_count,_inf_emits,_inf_bool_deltas,_inf_num_deltas,_inf_num_receipt,_inf_last_err,_inf_last_diag,_inf_why,_malloc,_free \
    -o "$out"
