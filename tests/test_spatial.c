...
int main(void)
{
    ...
    CHECK(dg.nerrors == 0);
    /* zero-warning again: the east/west double-assign hazard #98 flagged is
     * now DECLARED (`exclusive east, west`, #159) — the protocol is checked
     * at step time and the warning is discharged */
    CHECK(dg.count == 0);
